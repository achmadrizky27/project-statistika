  ...
  <body>
    ...
    <section class="kelas-mahasiswa" id="kelas-mahasiswa">
        <div class="container">
              ...
              <div class="row fw-semibold">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="text" name="npm" placeholder="..." class="form-control rounded-5 ps-3 border-black" autocomplete="off">
                  </div>
                  <div class="mb-3">
                    <label class="form-label">Nama Lengkap</label>
                    <input type="text" name="nama" placeholder="..." class="form-control rounded-5 ps-3 border-black" autocomplete="off">
                  </div>
                  <div class="mb-3">
            ...
            include 'connect.php';
            if(isset($_POST['save'])){
            $insert = mysqli_query($connect, "INSERT INTO tb_kelasmahasiswa VALUES 
                                    ('".$_POST['npm']."',
                                    '".$_POST['nama']."',
                                    '".$_POST['kelas']."')");
                if($insert){
                  $_SESSION['pesanKelasmahasiswa'] = "Suksess, data berhasil ditambahkan!";
